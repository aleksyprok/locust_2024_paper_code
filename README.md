...
- **Simulation Output Data**: Available on [OneDrive](https://stfc365-my.sharepoint.com/:f:/g/personal/alexander_prokopyszyn_stfc_ac_uk/Ev5nc3ZpORVPqvzkBBQJYCUBvavblAlrFArCqM6ZdTdg7g?email=alexander.prokopyszyn%40stfc.ac.uk&e=VVGKiy). Note that access to this OneDrive folder requires permission, as it is stored on a work account and exceeds 30 GB.
