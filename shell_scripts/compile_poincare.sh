...
# This shell script will scan over a set of parameters and produce poincare plots.
...
run_name="poincare_scan_bplasma"
poincare=1
...
for ((n=0; n<num_runs; n++)); do
    ...
    if [[ $poincare == 1 ]]; then
        FLAGS_BASE=$FLAGS_BASE" -DPOINCARE=3"
    fi
    echo $FLAGS_BASE
